...
<div class="container">
  ...
  <form action="/listings" method="POST">
    ...
    <div class="form-group">
      ...
      <input type="text" value="<?= $listing->title ?>" class="form-control" id="jobTitle" name="jobTitle" required>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <textarea class="form-control" id="description" name="description" required style="height: 150px;"><?= htmlspecialchars($listing->description) ?></textarea>
    </div>
    <div class="form-group">
      <label for="annualSalary">Annual Salary</label>
      <input value="<?= $listing->salary ?>" type="text" class="form-control" id="annualSalary" name="annualSalary" required>
    </div>
    <div class="form-group">
      <label for="requirements">Requirements</label>
      <textarea class="form-control" id="requirements" name="requirements" required style="height: 150px;"><?= htmlspecialchars($listing->description) ?></textarea>
    </div>
    <div class="form-group">
      <label for="benefits">Benefits</label>
      <textarea class="form-control" id="benefits" name="benefits" required style="height: 150px;"><?= htmlspecialchars($listing->benefits) ?></textarea>
    </div>

    <h3>Company Info & Location:</h3>
    <div class="form-group">
      <label for="companyName">Company Name</label>
      <input type="text" value="<?= $listing->company ?>" class="form-control" id="companyName" name="companyName" required>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <input type="text" value="<?= $listing->country ?>" class="form-control" id="country" name="country" required>
    </div>
    <div class="form-group">
